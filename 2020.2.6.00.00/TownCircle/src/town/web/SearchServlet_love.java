 ...
 */
@WebServlet(urlPatterns="/town/search_love")
public class SearchServlet_love extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("SearchServlet_love.java_DoGet()");
		//DAOの取得
		try(UserDAO dao = new UserDAO()) {
			//サークルのリストを一覧で取得し、リクエスト属性へ格納する
			List<Circle> list = dao.circleList_love();

 ...
 */
@WebServlet(urlPatterns="/town/search_event")
public class SearchServlet_event extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("SearchServlet_event.java_DoGet()");
		//DAOの取得
		try(UserDAO dao = new UserDAO()) {
			//サークルのリストを一覧で取得し、リクエスト属性へ格納する
			List<Circle> list = dao.circleList_event();

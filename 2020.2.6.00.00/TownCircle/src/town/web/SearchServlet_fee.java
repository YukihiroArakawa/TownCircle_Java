 ...
 */
@WebServlet(urlPatterns="/town/search_fee")
public class SearchServlet_fee extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("SearchServlet_fee.java_DoGet()");
		//DAOの取得
		try(UserDAO dao = new UserDAO()) {
			//サークルのリストを一覧で取得し、リクエスト属性へ格納する
			List<Circle> list = dao.circleList_fee();
